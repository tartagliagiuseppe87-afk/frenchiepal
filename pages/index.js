...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-[#eafaf7] to-[#ffffff] font-poppins text-gray-800 overflow-hidden">
      ...
      {/* 2. SEZIONE INTRODUTTIVA (Testo Completo Ripristinato) */}
      <div className="flex-none px-6 py-4 text-center">
        <div className="max-w-3xl mx-auto animate-fade-in-down">
            ...
            <div className="text-sm text-gray-600 leading-relaxed space-y-2 mb-2">
                <p>
                ...
                <p className="text-[#2a9d8f] font-medium pt-1">
                  🚀 <strong>Ci aiuti a migliorare?</strong> Poni domande specifiche qui sotto.
                </p>
            </div>
        </div>
      </div>
      ...
      {/* 4. FOOTER (Disclaimer Completo Ripristinato) */}
      <footer className="flex-none py-3 bg-white/50 border-t border-gray-200 text-center z-10 text-xs text-gray-500">
        <p className="leading-relaxed px-4">
          ⚠️ <strong>Disclaimer Importante:</strong> FrenchiePal è un assistente virtuale e non fornisce pareri medici veterinari. Le informazioni ricevute <strong>non sostituiscono in alcun modo una consulenza veterinaria professionale</strong>. Per problemi di salute seri o emergenze, contatta immediatamente il tuo veterinario di fiducia.
          <br />
          Consulta l'Informativa sulla <a href="/privacy" className="hover:text-[#2a9d8f] transition-colors font-semibold mt-1 inline-block sm:mt-0">Privacy Policy</a>. (Base Giuridica: Legittimo Interesse).
        </p>
      </footer>
