...
export default function Home() {
  return (
    <div className="flex flex-col h-screen bg-gradient-to-b from-[#eafaf7] to-[#ffffff] font-poppins text-gray-800 overflow-hidden">
      ...
      {/* 1. HEADER (Compattato MOLTO su Mobile) */}
      <header className="flex-none py-2 px-3 md:py-3 md:px-6 flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-gray-200/50 z-20 sticky top-0">
        ...
        {/* PRIVACY BADGE (Sempre visibile, ma compattato) */}
      ...
      {/* 2. SEZIONE INTRODUTTIVA (Massima Compattazione Verticale su Mobile) */}
      <div className="flex-none px-4 py-2 md:px-6 md:py-4 text-center">
