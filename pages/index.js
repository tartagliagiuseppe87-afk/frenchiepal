...
export default function Home() {
  return (
    // h-screen è corretto, forziamo il layout a rientrare
    <div className="flex flex-col h-screen bg-gradient-to-b from-[#eafaf7] to-[#ffffff] font-poppins text-gray-800 overflow-hidden">
      ...
      <div className="flex-none px-4 py-1 text-center md:px-6 md:py-2">
        <div className="max-w-3xl mx-auto animate-fade-in-down">
            ...
            <div className="mt-0">
                <p className="text-[10px] font-medium text-[#2a9d8f] bg-white border border-[#2a9d8f]/20 px-2 py-0.5 rounded-full shadow-sm">
      ...
      {/* 3. AREA CHAT (Contenitore principale che si espande) */}
      ...
      {/* FOOTER ELIMINATO COMPLETAMENTE */}
    </div>
  );
}
